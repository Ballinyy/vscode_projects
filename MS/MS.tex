...
\end{align}
dove si è usato $\frac{\partial S_2}{\partial E} = \frac{1}{T}$. In particolare, il termine $S_2(E)$ non dipende dalle variabili microscopiche del sottosistema $X_1$, pertanto si ottiene 
\begin{align}
