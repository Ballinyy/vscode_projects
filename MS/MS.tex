...
\end{gather}
Il sistema è isolato, quindi non ci sono sorgenti o pozzi. Posto $\mathbf{v} = (\dot{\mathbf{p}}, \dot{\mathbf{q}})$, segue che $P$ soddisfa la relazione di continuità (vedere appendice)
\begin{gather}
