...
\end{align}
non esiste $Z \in [0, 1]$ che soddisfa $(4.4.38)$, infatti, come già visto, $\zeta(3/2)$ è il valore massimo assunto da $g_{3/2}$ per $Z \in [0, 1]$. Concludiamo che, se vale $(4.4.39)$, si ha $Z = 1$, i livelli eccitati sono saturi e le particelle iniziano a condensarsi nello stato fondamentale. Tale fenomeno è detto \textit{condensazione di Bose-Einstein}. \\ \\
