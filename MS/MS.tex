...
\end{align}
Cerchiamo un modo per poter scrivere la funzione di partizione canonica come segue 
\begin{align}
    Q_N = \sum_{N_1}\frac{1}{h^{3N_1}}\int d\mathbf{p}_1d\mathbf{q}_1 \, (\dots) \tag{3.1.1}
\end{align}
Dato un sistema costituito da $N$ particelle indistinguibili vale la seguente identità 
\begin{align}
...
\begin{align}
    1 = \sum_{N_1 = 0}\int d\mathbf{p}_1d\mathbf{q}_1 \, \rho_{N_1}(\mathbf{p}_1, \mathbf{q}_1) \notag
\end{align}
...
\begin{align}
    ...
    &= -\mu N_1 + PV_1 \tag{3.1.5}
\end{align}
sostituendo in $(3.1.4)$ si ottiene 
\begin{align}
    \rho_{N_1}(\mathbf{p}_1, \mathbf{q}_1) \sim e^{-\beta(PV_1 -\mu N_1)}\frac{e^{-\beta \mathcal{H}_{N_1}}}{N_1|h^{3N_1}} \tag{3.1.6}
\end{align}
