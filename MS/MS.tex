...
\begin{align}
    ...
    &= -\frac{\mathcal{N}}{\beta v^2}\underbrace{\left(\frac{\partial P}{\partial v}\right)^{-1}_{T, V}}_{\text{compressibilità isoterma}} \tag{3.2.16}
\end{align}
Osserviamo che le fluttuzioni del numero di particelle sono legate alla compressibilità isoterma $\kappa_T = \left(\frac{\partial P}{\partial v}\right)^{-1}_T$. Inoltre
\begin{align}
    \frac{\sqrt{\braket{(\Delta N)^2}}}{\mathcal{N}} = \left(-\frac{1}{\beta v^2}\left(\frac{\partial P}{\partial v}\right)^{-1}_T\right)^{1/2}\left(\frac{1}{\mathcal{N}}\right)^{1/2} \tag{3.2.17}
\end{align}
ovvero le fluttuazioni diventano trascurabili al limite termodinamico $\mathcal{N} \rightarrow \infty$ ($v$ è fissata dato che al limite termidinamico $V \rightarrow \infty$ e $\mathcal{N} \rightarrow \infty$ in modo tale che $V/N \propto 1$).
