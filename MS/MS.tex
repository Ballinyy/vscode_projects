...
\end{align}
quindi, sostituendo il risultato ottenuto in $(4.4.26)$
\begin{align}
    \frac{4}{3\sqrt{\pi}}\overbrace{(\beta\mu)^{3/2}}^{\eta^{3/2}}\left(1 + \frac{\pi^2}{8}(\beta\mu)^{-1} + \dots\right) = \frac{1}{g_s}\frac{\mathcal{N}}{V}\left(\frac{\beta h^2}{2\pi m}\right)^{3/2} \tag{4.4.27}
\end{align}
