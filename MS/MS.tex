...
\newpage
\subsection{Particelle soggette a potenziale armonico in una scatola}
...
\newpage
\subsection{Particelle ultra-relativistiche libere in una scatola}
...
\begin{align}
    Q_N = \frac{V^N}{N!}\left(\frac{2\pi mkT}{h^2}\right)^{3N/2} \tag{2.3.1}
\end{align}
Notiamo che 
\begin{align}
    Q_N = Q^N_1 \tag{2.1.23}
