...
\newpage
\subsection{Correzioni quantistiche al limite classico}
...
\end{align}
Sviluppiamo $(4.5.4)$ in serie per $Z << 1$
\begin{align}
    \mathcal{N} &= \frac{4\pi g_sV}{\beta^3c^3h^3}\int_0^\infty dx \, \frac{Zx^2}{e^x + Z} \notag \\
    &\sim \frac{4\pi g_sV}{\beta^3c^3h^3}\left(Z\int_0^\infty x^2e^x + Z^2\int_0^\infty ...\right)\tag{4.5.5}
\end{align}
