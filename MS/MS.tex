...
Vediamo come $\rho$ evolve nel tempo. Consideriamo una regione $\Omega$ dello spazio delle fasi e sia $\Sigma = \partial \Omega$. La probabilità $P(t)$ di trovare il sistema in un stato contenuto in $\Omega$ in un dato istante $t$ è data da
\begin{gather}
    P(t) = \int_{\Omega}\rho(\mathbf{p}(t), \mathbf{q}(t)) \, d\mathbf{p}d\mathbf{q} \tag{1.1.6}
\end{gather}
Posto $\mathbf{v} = (\dot{\mathbf{p}}, \dot{\mathbf{q}})$, calcolando la derivata totale rispetto al tempo, si ottiene
\begin{gather}
    \frac{dP}{dt} = \int_{\Omega}\frac{\partial \rho}{\partial t} \, d\mathbf{p}d\mathbf{q} + \int_{\Omega}\nabla \rho \cdot \mathbf{v} \, d\mathbf{p}d\mathbf{q} \tag{1.1.7}
\end{gather}
...
\begin{align}
    \frac{dP}{dt} = -\int_{\Omega}\rho\nabla \cdot \mathbf{v} \, d\mathbf{p}d\mathbf{q} \tag{1.1.8}
\end{align}
