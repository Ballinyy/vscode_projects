...
\newpage
\subsection{Particelle libere}
Ora tutte le variabili dinamiche e le varie osservabili saranno rappresentate da operatori quantistici. Consideriamo un sistema tridimensionale composto da $N$ particelle indipendenti e indistinguibili (senza ancora specificare se fermioni o bosoni). L'hamiltoniano che descrive tale sistema è
\begin{align}
    \mathcal{H} = \sum_{i = 1}^N \frac{\mathbf{p}^2_i}{2m} \tag{4.3.1}
\end{align}
