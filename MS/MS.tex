...
Inoltre, da $(2.3.8)$ notiamo che
\begin{align}
    \frac{\sqrt{\braket{(U - \mathcal{H})^2}}}{U} = \frac{kT^2}{\sqrt{U}} \tag{2.3.10}
\end{align}
pertanto le fluttuazioni dell'energia sono trascurabili al limite termodinamico ($U >> 1$).
