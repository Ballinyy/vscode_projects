...
\textbf{1.} Consideriamo un insieme di $N$ siti a due stati, in particolare ogni sito del sistema può avere energia $0$ o energia $\varepsilon$ fissata. Fissata l'energia del sistema siamo interessati a determinare l'espressione dell'entropia al limite termodinamico. \\
...
\begin{align}
    ...
    &= k\left(N\ln\frac{N}{N - m} - m\ln\frac{m}{N - m}\right) \notag
\end{align} \\
\textbf{2.} Consideriamo un sistema composto da $N$ oscillatori armonici quantistici unidimensionali. Fissata l'energia del sistema siamo interessati a determinare l'espressione dell'entropia al limite termodinamico. \\
