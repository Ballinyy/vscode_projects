...
\end{align}
Notiamo immediatamente che $g_\nu$ è crescente in $Z$. Inoltre, come fatto in $(4.4.16)$, possiamo riscrivere le funzioni di Bose in termini di serie note
\begin{align}
...
\begin{align}
    \frac{Z}{1 - Z} \rightarrow V \qquad Z \rightarrow 1 \notag
\end{align}
in modo tale da rendere anche il terzo termine intensivo. Riscrivendo $(4.4.34)$ in termini delle funzioni di Bose e del parametro $\lambda$ introdotto precedentemente, si ottiene
\begin{align}
...
\end{align}
Questa equazione comporta che il termine $\frac{\mathcal{N}_0}{V} > 0$ se la temperatura $T$ ed il volume specifico $v$ sono tali che 
\begin{align}
    \frac{\lambda^3}{v} - \overbrace{g_{3/2}(1)}^{\zeta(3/2)} > 0 \notag
\end{align}
In particolare, ciò significa che la frazione di particelle che occupa lo stato fondamentale è non infinitesima. Tale fenomeno è detto \textit{condensazione di Bose-Einstein}. \\ \\
La fugacità $Z$ che risolve $(4.4.36)$ ha il seguente comportamento
\begin{center}
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.65\linewidth]{immagini/Screenshot 2026-07-10 142023.png}
        \caption{$Z$ soluzione di $(4.4.36)$}
        \label{}
    \end{figure}
\end{center}
Notiamo che $0 < Z < 1$. Dunque, al limite $V \rightarrow \infty$, la soluzione $Z$ diventa una funzione a gradino e si ottiene
\begin{align}
    Z = \begin{cases}
        1 \qquad &\frac{v}{\lambda^3} \leq \zeta(3/2) \\
        \text{soluzione di} (4.4.36) \qquad &\frac{v}{\lambda^3} > \zeta(3/2)
    \end{cases} \tag{4.4.37}
\end{align}
Vediamo ora cosa emerge dall'equazione $(4.4.36)$ se facciamo variare $T$ a $v$ fissato. L'equazione
\begin{align}
    \frac{\lambda^3}{v} = g_{3/2}(1) \tag{4.4.38}
\end{align}
identifica una determinata temperatura $T_c$, detta \textit{temperatura critica}, data da
\begin{align}
    T_c = \frac{h^2}{2\pi km}\left(\frac{1}{v\zeta(3/2)}\right)^{2/3} \tag{4.4.39}
\end{align}
Per $T > T_c$ si ha $\frac{v}{\lambda^3} > \zeta(3/2)$, pertanto
\begin{align}
    \frac{\mathcal{N}_0}{\mathcal{N}} = 1 - \frac{v}{\lambda^3}g_{3/2}(Z) = 0 \tag{4.4.40}
\end{align}
ovvero non ci sono particelle che occupano lo stato fondamentale (o sono una frazione infinitesima). Mentre, per $T < T_c$, ricordando che $g_{3/2}(1) = \zeta(3/2)$ e sostituendo $(4.4.39)$ in $(4.4.40)$, si ottiene
\begin{align}
    \frac{\mathcal{N}_0}{\mathcal{N}} = 1 - \left(\frac{T}{T_c}\right)^{2/3} \tag{4.4.41}
\end{align}
ovvero si osserva una frazione \textit{non} infinitesima di particelle che occupano lo stato fondamentale.
\begin{center}
    \begin{figure}[h]
        \centering
...
\begin{align}
    Z = \begin{cases}
        1 \qquad &v \leq v_c \\
        \text{soluzione di} (4.4.36) \qquad &v > v_c
    \end{cases} \qquad
    P = \begin{cases}
    ...
    \end{cases} \tag{4.4.42}
\end{align}
Tuttavia, non sempre esiste $T_c > 0$, infatti un primo esempio è il caso di bosoni liberi in un dominio bidimensionale. In tal caso si ottiene $Z = 1$ solo per $T = 0$.
