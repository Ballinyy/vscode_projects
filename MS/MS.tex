...
\begin{gather}
    S(E, N, V) = k\left(\log c_{3N} + N\log \frac{V}{h^3} + \frac{3}{2}\log (2mE)\right) \tag{1.2.22}
\end{gather}
...
e
\begin{gather}
    S(E, N, V) \sim kN\log\left(V\left(\frac{4\pi m}{3h^2}\frac{E}{N}\right)^{3/2}\right) + \frac{3}{2}Nk \qquad N \rightarrow \infty \tag{1.2.23} 
\end{gather}
...
Tuttavia, l'espressione $(1.2.23)$ dell'entropia non è estensiva a causa del termine $V$ all'interno del logaritmo. Questo accade perché non abbiamo tenuto conto dell'indistinguibilità classica delle particelle per il gas ideale nell'integrazione rispetto a $d\mathbf{q}$ per il calcolo di $\Omega(E)$. Necessitiamo dunque di un fattore $N!$, detto \textit{fattore di Gibbs}, a dividere $\Gamma$ (o $\Omega$) per correggere il problema. Tale fattore apparirà autonomamente quando considereremo l'indistinguibilità quantistica delle particelle. \\ \\
Poniamo $u = E/N$ e $v = V/N$ e riscriviamo $S$ come segue
\begin{align}
    S(E, N, V) = kN\log(Vu^{2/3}) + \frac{3}{2}kNS_0 \tag{1.2.25}
\end{align}
dove
\begin{align}
...
\begin{align}
    k\log\Omega \longrightarrow k\log\Omega - k\log N! \tag{1.2.26}
\end{align}
...
\subsubsection{Particelle ultra-relativistiche libere in una scatola}
...
\begin{align}
    \Omega = \frac{1}{h^{3N}}\int_{\sum |\mathbf{p}_i| \leq E/c} d\mathbf{p}d\mathbf{q} \tag{1.2.32}
\end{align}
L'equazione
\begin{align}
...
\end{align}
Confrontando $(1.2.38)$ e $(1.2.39)$ viene naturale ragionare per induzione, dunque supponiamo che per $k < n$ valga
\begin{align}
...
\begin{align}
    \Omega = \left(\frac{4\pi V}{h^3}\right)^N\frac{2^N}{(3N)!}\left(\frac{E}{c}\right)^{3N} \tag{1.2.41}
\end{align}
...
\begin{align}
    \Omega = \frac{1}{N!}\frac{1}{(3N)!}\left(\frac{8\pi V E^3}{h^3c^3}\right)^N \tag{1.2.42}
\end{align}
Allora
\begin{align}
    S &\sim k\log \Omega \notag \\
