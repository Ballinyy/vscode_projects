...
\end{align}
Esplicitiamo i termini in $(4.4.10)$ e $(4.4.11)$
\begin{align}
    \frac{\partial}{\partial Z}f_{5/2}(Z) &= \frac{8}{3\sqrt{\pi}}\int_0^\infty dx \, \frac{\partial}{\partial Z}\left(\frac{x^{3/2}}{Z^{-1}e^x + 1}\right) \notag \\
    &= \frac{8}{3\sqrt{\pi}}\int_0^\infty dx \, \frac{\partial}{\partial Z}\left(\frac{Zx^{3/2}e^{-x}}{1 + Ze^{-x}}\right) \notag \\
    &= \frac{8}{3\sqrt{\pi}}\int_0^\infty dx \, \frac{\frac{3}{2}Zx^{1/2}e^{-x}(1 + Ze^{-x}) - Zx^{3/2}e^{-x}}{(1 + Ze^{-x})^2} \notag \\
    &= \frac{8}{3\sqrt{\pi}}\int_0^\infty dx \, \left(\frac{3}{2}Z\frac{x^{1/2}e^{-x}}{1 + Ze^{-x}} - Z\frac{x^{3/2}e^{-x}}{(1 + Ze^{-x})^2}\right) \tag{4.4.12}
\end{align}
