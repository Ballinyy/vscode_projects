...
\end{align}
Pertanto, facendo riferimento all'espressione $(2.1.5)$, diamo come definizione statistica dell'energia libera la seguente 
\begin{align}
    G(N, V, T) = -kT\ln Q_N(V, T) \tag{2.1.8}
\end{align}
Verifichiamo che sia correttamente estensiva. Poiché per ipotesi $X_1$ e $X_2$ sono debolmente interagenti si ha che $\mathcal{H}_{tot} = \mathcal{H}_1 + \mathcal{H}_2$, pertanto 
\begin{align}
...
\begin{align}
    ...
    &= G_1 + G_2 \tag{2.1.9}
\end{align}
ovvero $G$ correttamente estensiva (al limite termodinamico di sottosistemi debolmente interagenti). \\
Osserviamo che il termine $E$ nella definizione dell'energia libera non è l'energia del sistema, infatti quest'ultima è una variabile stocastica per gli ensemble canonici. La corretta definizione di $G$ è 
\begin{align}
...
\begin{align}
    \Delta \mathcal{H} = \sqrt{\braket{\mathcal{H}^2} - \braket{\mathcal{H}}^2} \tag{2.1.12}
\end{align}
...
\begin{align}
    \braket{\mathcal{H}} = \frac{1}{h^{3N}}e^{\beta G}\int d\mathbf{p}d\mathbf{q} \, \mathcal{H}e^{-\beta\mathcal{H}} = \frac{1}{h^{3N}}\int d\mathbf{p}d\mathbf{q} \, \mathcal{H}e^{\beta(G - \mathcal{H})} \tag{2.1.13}
\end{align}
per $(2.1.11)$ si ha 
\begin{align}
...
\begin{align}
    \braket{\mathcal{H}} = \frac{1}{h^{3N}}\int d\mathbf{p}d\mathbf{q} \, \braket{\mathcal{H}}e^{\beta(G - \mathcal{H})} \tag{2.1.14}
\end{align}
confrontando $(2.1.13)$ e $(2.1.14)$ si ottiene 
\begin{align}
    \frac{1}{h^{3N}}\int d\mathbf{p}d\mathbf{q} \, (\braket{\mathcal{H}} - \mathcal{H})e^{\beta(G - \mathcal{H})} = 0 \tag{2.1.15}
\end{align}
...
\begin{align}
    ...
    &= \frac{1}{h^{3N}}\int d\mathbf{p}d\mathbf{q} \, \left(\frac{\partial \braket{\mathcal{H}}}{\partial \beta} + (\braket{\mathcal{H}} - \mathcal{H})\left(G - \mathcal{H} + \beta\left(\frac{\partial G}{\partial \beta}\right)_{N, V}\right)\right)e^{\beta(G - \mathcal{H})} \tag{2.1.16}
\end{align}
...
\begin{align}
    ...
    &= G + TS \notag \\
    &= \braket{\mathcal{H}} \tag{2.1.17}
\end{align}
e sostituendo in $(2.1.16)$ si ha 
\begin{align}
    \frac{\partial \braket{\mathcal{H}}}{\partial \beta} + \braket{(\braket{\mathcal{H}} - \mathcal{H})^2} = 0 \tag{2.1.18}
\end{align}
...
ovvero 
\begin{align}
    \braket{(U - \mathcal{H})^2} = kT^2U \tag{2.1.19}
\end{align}
...
\begin{align}
    \frac{\sqrt{\braket{(U - \mathcal{H})^2}}}{U} \sim \frac{1}{\sqrt{N}} \rightarrow 0 \tag{2.1.10}
\end{align}
