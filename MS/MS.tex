...
\end{align}
Notiamo che la funzione integranda è prodotto di una funzione crescente e una funzione decrescente (dell'energia) ed ha quindi un punto di massimo globale. In particolare 
\begin{align}
...
\end{align}
Se $\Gamma(E) \propto E^\alpha$, con $\alpha \propto N$, si ha
\begin{align}
    1 = T\left(\frac{\partial S_{mic}}{\partial E}\right)_{E = \overline{E}} \propto \frac{\alpha kT}{\overline{E}} \notag
\end{align}
Pertanto
\begin{align}
    \overline{E} \propto \alpha kT \notag
\end{align}
Quindi ha senso approssimare la funzione integranda attorno al suo punto di massimo. In particolare 
\begin{align}
...
\end{align}
 Inoltre, la derivata seconda di $S_{mic}$ calcolata per $E = \overline{E}$ è un termine negativo, infatti $\overline{E}$ è un punto di massimo per $S_{mic}$. Concludiamo che la funzione integranda in $(2.8.5)$ è una gaussiana con varianza $\sigma = \sqrt{N}$ 
\begin{align}
