...
Consideriamo un corpo nero di volume $V$ ed a temperatura $T$ contenente radizione elettromagnetica. \\
...
\end{align}
possono essere ricavata anche da considerazioni classiche. \\ \\
Infine, confrontando con le equazioni caratteristiche dell'enseble grancanonico quantistico, osserviamo che sono identiche a mano di porre $Z = 1$, ovvero $\mu = 0$. Questo perché i fotoni sono liberi di essere assorbiti ed emessi dalle pareti del corpo nero.
