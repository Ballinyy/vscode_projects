...
\begin{align}
    \Gamma_N(E) = \frac{N!}{\left(\frac{1}{2}\left(N + \frac{E}{\varepsilon}\right)\right)!\left(\frac{1}{2}\left(N - \frac{E}{\varepsilon}\right)\right)!} \notag
\end{align}
Usando la formula di Stirling al limite termidinamico si ha 
\begin{align}
    \Gamma_N(E) \sim \frac{N^{N + \frac{1}{2}}}{\left(\frac{1}{2}\left(N + \frac{E}{\varepsilon}\right)\right)^{\frac{1}{2}\left(N + \frac{E}{\varepsilon}\right) + \frac{1}{2}}\left(\frac{1}{2}\left(N - \frac{E}{\varepsilon}\right)\right)^{\frac{1}{2}\left(N - \frac{E}{\varepsilon}\right) + \frac{1}{2}}} \tag{2.1.40}
\end{align}
