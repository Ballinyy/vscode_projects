...
\begin{align}
    \Delta \mathcal{H} = \sqrt{\braket{\mathcal{H}^2} - \braket{\mathcal{H}}^2} \tag{2.2.1}
\end{align}
...
\begin{align}
    \braket{\mathcal{H}} = \frac{1}{h^{3N}}e^{\beta G}\int d\mathbf{p}d\mathbf{q} \, \mathcal{H}e^{-\beta\mathcal{H}} = \frac{1}{h^{3N}}\int d\mathbf{p}d\mathbf{q} \, \mathcal{H}e^{\beta(G - \mathcal{H})} \tag{2.2.2}
\end{align}
per $(2.1.11)$ si ha 
\begin{align}
...
\begin{align}
    \braket{\mathcal{H}} = \frac{1}{h^{3N}}\int d\mathbf{p}d\mathbf{q} \, \braket{\mathcal{H}}e^{\beta(G - \mathcal{H})} \tag{2.2.3}
\end{align}
confrontando $(2.2.2)$ e $(2.2.3)$ si ottiene 
\begin{align}
    \frac{1}{h^{3N}}\int d\mathbf{p}d\mathbf{q} \, (\braket{\mathcal{H}} - \mathcal{H})e^{\beta(G - \mathcal{H})} = 0 \tag{2.2.4}
\end{align}
...
\begin{align}
    ...
    &= \frac{1}{h^{3N}}\int d\mathbf{p}d\mathbf{q} \, \left(\frac{\partial \braket{\mathcal{H}}}{\partial \beta} + (\braket{\mathcal{H}} - \mathcal{H})\left(G - \mathcal{H} + \beta\left(\frac{\partial G}{\partial \beta}\right)_{N, V}\right)\right)e^{\beta(G - \mathcal{H})} \tag{2.2.5}
\end{align}
...
\begin{align}
    ...
    &= G + TS \notag \\
    &= \braket{\mathcal{H}} \tag{2.2.6}
\end{align}
e sostituendo in $(2.2.5)$ si ha 
\begin{align}
    \frac{\partial \braket{\mathcal{H}}}{\partial \beta} + \braket{(\braket{\mathcal{H}} - \mathcal{H})^2} = 0 \tag{2.2.7}
\end{align}
...
ovvero 
\begin{align}
    \braket{(U - \mathcal{H})^2} = kT^2U \tag{2.2.8}
\end{align}
...
\begin{align}
    \braket{x_i\frac{\partial\mathcal{H}}{\partial x_j}} = \delta_{ij}kT \tag{2.2.10}
\end{align}
per ogni $i, j = 1, \dots, 6N$. \\
...
\begin{align}
    ...
    &= \frac{1}{Q_Nh^{3N}\beta}\cancel{\int \prod_{\tilde{x}_j \in (\mathbf{p}, \mathbf{q}) \setminus x_j}d\tilde{x}_j \, x_i e^{-\beta\mathcal{H}}|_{x_j^{(1)}}^{x_j^{(2)}}} + \frac{1}{Q_Nh^{3N}\beta}\int d\mathbf{p}d\mathbf{q} \, \frac{\partial x_i}{\partial x_j}e^{-\beta\mathcal{H}} \notag \\
    &= \delta_{ij}kT \notag
\end{align}
poiché la prima funzione integranda si annulla agli estremi.

\subsubsection{Esempio: gas libero}
Consideriamo un gas libero e supponiamo che valga il teorema di equipartizione dell'energia anche per l'ensemble canonico (che dimostreremo in seguito), allora $U \sim N$, ciò comporta che 
\begin{align}
    \frac{\sqrt{\braket{(U - \mathcal{H})^2}}}{U} \sim \frac{1}{\sqrt{N}} \rightarrow 0 \tag{2.2.10}
\end{align}
per $N \rightarrow \infty$, quindi l'ensemble canonico si comporta come l'ensemble microcanonico al limite termodinamico, infatti le fluttuazioni dell'energia diventano trascurabili rispetto al valore medio. \\ \\
Una volta dimostrato il teorema di equipartizione dell'energia anche per l'ensemble canonico vedremo che si ottiene lo stesso risultato anche per gli altri casi studiati in precedenza.

\subsection{Entropia canonica}
Facendo un cambio di variabili opportuno si ha 
\begin{align}
    Q_N = \frac{1}{h^{3N}}\int d\mathbf{p}d\mathbf{q} \, e^{-\beta\mathcal{H}} = \int_0^\infty dE \, \frac{1}{\Gamma(E)}e^{-\beta E} \tag{2.3.1}
\end{align}
ovvero integrando su tutte le ipersuperficie a energia fissata nello spazio delle fasi. Per definizione 
\begin{align}
    \Gamma(E) = \exp\left(-\frac{S_{mic}(E)}{k}\right) \tag{2.3.2}
\end{align}
sostituendo $(2.3.2)$ in $(2.3.1)$ si ha 
\begin{align}
    Q_N &= \int_0^\infty dE \, \exp\left(-\frac{S_{mic}(E)}{k} - \beta E\right) \notag \\
    &= \int_0^\infty dE \, \exp\left(-\beta\left(TS_{mic}(E) + E\right)\right) \tag{2.3.3}
\end{align}
...
\begin{align}
    TS_{mic}(E) - E \sim TS_{mic}(\overline{E}) - \overline{E} + \frac{1}{2}(E - \overline{E})^2T\left(\frac{\partial^2S_{mic}}{\partial E^2}\right)_{E = \overline{E}} \tag{2.3.4}
\end{align}
ponendo $\eta = E - \overline{E}$ si ottiene 
\begin{align}
    Q_N \sim \frac{1}{h^{3N}}\exp\left(\beta(TS_{mic}(\overline{E}) - \overline{E})\right)\int_0^\infty d\eta \, \exp\left(\frac{1}{2k}\left(\frac{\partial^2S_{mic}}{\partial E^2}\right)_{E = \overline{E}}\eta^2\right) \tag{2.3.5}
\end{align}
Notiamo che la derivata seconda di $S_{mic}$ calcolata per $E = \overline{E}$ è un termine nergativo, infatti $\overline{E}$ è un punto di massimo per $S_{mic}$, segue che l'integrale in $(2.3.5)$ è gaussiano, quindi 
\begin{align}
    Q_N \sim \frac{1}{h^{3N}}\exp\left(\beta(TS_{mic}(\overline{E}) - \overline{E})\right)\left(-2\pi k\left(\frac{\partial^2S_{mic}}{\partial E^2}\right)^{-1}_{E = \overline{E}}\right)^{1/2} \tag{2.3.6}
\end{align}
...
\begin{align}
    U - TS_{can} \sim \overline{E} - TS_{mic} - \frac{kT}{2}\ln\left(2\pi kT^2\frac{\partial \overline{E}}{\partial T}\right) \tag{2.3.7}
\end{align}
e, dato che $U \sim \overline{E}$, si ottiene 
\begin{align}
    S_{can} \sim S_{mic} + \frac{kT}{2}\ln\left(2\pi kT^2c_V\right) \tag{2.3.8}
\end{align}
