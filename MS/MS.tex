...
\begin{align}
    \braket{E} = \sum_{N, E_N} E_NP(E_N) = -\left(\frac{\partial}{\partial\beta}\ln \tilde{Q}\right) _{Z, V}\notag
\end{align}
per $(3.1.12)$ si ha che 
\begin{align}
    -\left(\frac{\partial}{\partial\beta}\ln \tilde{Q}\right)_{Z, V} = -ZV\frac{\partial}{\partial\beta}f(T) = ZVf'(T)kT^2 \tag{3.1.23}
\end{align}
...
\begin{align}
    c_V &= \left(\frac{\partial}{\partial T}\braket{E}\right)_{Z, V} \notag \\
    &= \left(\frac{\partial}{\partial T}\frac{f'(T)}{f(T)}\braket{N}kT^2\right)_{Z, V} \notag \\
    &= \braket{N}kT\frac{2f(T)f'(T) + Tf(T)f''(T) - T(f'(T))^2}{(f(T))^2} \tag{3.1.24}
\end{align}
...
Per $(3.1.12)$ si ha che 
\begin{align}
    P(E_N) &= \frac{Z^Nd(E_N)e^{-\beta E_N}}{\sum_{N, E_N}Z^Nd(E_N)e^{-\beta E_N}} \notag \\
    &= \frac{Z^NQ_N}{\sum_N Z^NQ_N} \notag \\
    &= \frac{Z^NQ^N_1}{N!}e^{-ZQ_1} \notag \\
    &= \frac{\braket{N}}{N!}e^{-\braket{N}} \tag{3.1.25}
\end{align}
ovvero $P(E_N)$ è una distribuzione poissoniana. Nell'appendice si dimostra che per $\braket{N} \rightarrow \infty$ la distribuzione poissoniana si comporta come una distribuzione gaussiana. \\ \\
...
\begin{align}
    ...
    &= \frac{\sum_{N}N^2Z^NQ_N}{\sum_{N}Z^NQ_N} - \left(\frac{\sum_{N}NZ^NQ_N}{\sum_{N}Z^NQ_N}\right) \tag{3.1.26}
\end{align}
Verifichiamo che vale la seguente relazione 
\begin{align}
    \braket{(\Delta N)^2} = Z\left(\frac{\partial}{\partial Z}\braket{N}\right)_{V, T} \tag{3.1.27}
\end{align}
Si ha che 
\begin{align}
    ...
    &= \frac{\sum_{N}N^2Z^NQ_N}{\sum_{N}Z^NQ_N} - \left(\frac{\sum_{N}NZ^NQ_N}{\sum_{N}Z^NQ_N}\right) \tag{3.1.28}
\end{align}
ovvero $(3.1.27)$ è dimostrata.
...
pertanto 
\begin{align}
    P(x) \sim \frac{1}{\sqrt{2\pi}}e^{-\lambda}\frac{\lambda^x}{e^{-x}x^{x + 1/2}} = \frac{1}{\sqrt{2\pi}}e^{-\lambda + x\ln \lambda + x - (x + 1/2)\ln x} \notag
\end{align}
Consideriamo solamente l'esponente, sostituendo $x = \lambda + \Delta$ si ha 
\begin{align}
    \cancel{-\lambda} + (\lambda + \Delta)\ln \lambda + (\cancel{\lambda} + \Delta) + (\lambda + \Delta + 1/2)\ln(\lambda + \Delta) \notag
\end{align}
