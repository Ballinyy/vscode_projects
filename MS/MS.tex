...
\begin{align}
    Q_N &= \sum_{N_1 = 0}^N \frac{N!}{N_1!N_2!}\frac{1}{h^{3N_1}}\int d\mathbf{p}_1d\mathbf{q}_1 \, e^{-\beta\mathcal{H}_{N_1}}\left(\frac{1}{h^{3N_2}}\int d\mathbf{p}_2d\mathbf{q}_2 \, e^{-\beta\mathcal{H}_{N_2}}\right) \notag \\
    &= \sum_{N_1 = 0}^N \frac{N!}{N_1!(N - N_1)!}Q_{N_1}Q_{N - N_1} \tag{3.1.3}
\end{align}
Poniamo allora 
\begin{align}
    \rho_{N_1}(\mathbf{p}_1, \mathbf{q}_1) &= \frac{N!}{Q_N}\frac{e^{-\beta\mathcal{H}_{N_1}}}{N_1!h^{3N_1}} \cdot \frac{1}{N_2!h^{3N_2}}\int d\mathbf{p}_2d\mathbf{q}_2 \, e^{-\beta\mathcal{H}_{N_2}} \notag \\
    &= N!\frac{Q_{N_2}}{Q_N}\frac{e^{-\beta\mathcal{H}_{N_1}}}{N_1!h^{3N_1}} \notag \\
    &= N!e^{-\beta(G_{N_2}(V_2, T) - G_N(V, T))}\frac{e^{-\beta\mathcal{H}_{N_1}}}{N_1!h^{3N_1}} \tag{3.1.4}
\end{align}
...
\begin{align}
    \rho_{N_1}(\mathbf{p}_1, \mathbf{q}_1) \sim N!e^{-\beta(PV_1 -\mu N_1)} \tag{3.1.6}
\end{align}
