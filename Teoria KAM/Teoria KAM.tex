...
\textbf{2.} Il flusso $\varphi_t$ del campo vettoriale costante $\alpha$ è \textit{ergotico}, ovvero tutte le funzioni $f$ che soddisfano
\begin{align}
...
\textbf{Dimostrazione:} $(1 \rightarrow 2)$ supponiamo $f \circ \varphi_t = f$ per ogni $t \in \mathbb{R}$. Il $k$-esimo coefficiente di Fourier di $f \circ \varphi_t$ è dato da 
\begin{align}
