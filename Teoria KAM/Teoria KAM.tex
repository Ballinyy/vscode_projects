...
Date $\omega^{(k)}$ e $\omega^{(l)}$ rispettivamente una $k$-forma e una $l$-forma su $\mathbb{R}^n$, possiamo scrievere 
\begin{align}
    \omega^{(k)} = \omega_1 \wedge \dots \wedge \omega_k \qquad \omega^{(l)} = \omega_{k + 1} \wedge \dots \wedge \omega_{k + l} \tag{1.4.1}
\end{align}
dove $\omega_1, \dots, \omega_{k + l}$ sono opportune $1$-forme su $\mathbb{R}^n$.
