...
\textbf{Definizione:} è detta $1$-\text{forma sulla varietà} $M$ l'applicazione regolare
\begin{align}
...
\end{align*}
ovvero $\omega = dA$. \qed \\ \\
\textbf{Osservazione:} se consideriamo $1$-forme su $\mathbb{R}^2$, o su qualsiasi altra $2$-varietà differenziabile, la \textit{proposizione 1.6.1} non è più valida. Esibiamo una $1$-forma su $\mathbb{R}^2$ che non è il differenziale di alcuna funzione del piano nella retta. \\
