...
\textbf{Lemma 5.1:} se $\alpha$ è non risonante, data $g \in \mathscr{F}$ esiste unica $f \in \mathscr{F}$ tale che $\mathcal{L}_\alpha f = g$. \\
...
\begin{flalign}
    |k \cdot \alpha| \geq \frac{\gamma}{\|k\|^{\tau}_1} \tag{5.16}
\end{flalign}
per ogni $k \in \mathbb{Z}^n \setminus \{0\}$, dove
\begin{flalign}
    \|k\|_1 = |k_1| + \dots + |k_n| \tag{5.17}
\end{flalign}
...
\end{flalign}
per ogni $i = 1, \dots, n$. In particolare, esistono $(q + 1)^n$ vettori in $\mathbb{Z}^n$ che soddisfano $(5.20)$, infatti ogni componente ha $q + 1$ possibili valori da assumere (compreso $0$) e ci sono $n$ componenti totali. \\
Per ogni $\kappa \in \mathbb{Z}^n$ che soddisfa $(5.20)$ poniamo $x_\kappa = |\{\kappa \cdot \alpha\}|$, dove $\{\cdot\}$ indica l'operazione di parte frazionaria. La parte frazionaria di un numero qualsiasi è sempre compresa tra $0$ e $1$ (escluso). \\
...
\textbf{Teorema [Poschel]:} per $\tau > n - 1$ si ha che la misura di Lebesgue $n$-dimensionale dell'insieme $D_\tau$ tende alla misura piena di $\mathbb{R}^n$, ovvero quasi tutti i vettori $\alpha \in \mathbb{R}^n$ soddisfano
\begin{align}
    |k \cdot \alpha| \geq \frac{\gamma}{\|k\|^\tau_1} \tag{5.23}
\end{align}
per qualche $\gamma > 0$. \\

\textbf{Dimostrazione:} $D_{\gamma, \tau}$ è il complementare dell'aperto
\begin{align}
    R_{\gamma, \tau} = \bigcup_{0 \neq k \in \mathbb{Z}}\left\{\alpha \in \mathbb{R}^n : |k \cdot \alpha| < \frac{\gamma}{\|k\|^\tau_1}\right\} = \bigcup_{0 \neq k \in \mathbb{Z}} R_{\gamma, \tau, k} \tag{5.24}
\end{align}
Dato un qualsiasi dominio misurabile $\Omega \subset \mathbb{R}^n$ (ad esempio un disco), si ha che
\begin{align}
    m(R_{\gamma, \tau, k} \cap \Omega) = o(\gamma/\|k\|^\tau_1) \tag{5.25}
\end{align}
Infatti la condizione in $(5.4)$ è equivalente a
\begin{align}
    \left|\frac{k}{\|k\|_1} \cdot \alpha\right| \leq \frac{\gamma}{\|k\|^{\tau + 1}_1} \tag{5.26}
\end{align}
Essenzialmente ci dice che il modulo della proiezione di $\alpha$ (ricordiamo $\|\cdot\|_1 \geq \|\cdot\|_2$) su $k$ deve essere limitato da $\gamma/\|k\|^{\tau + 1}_1$. \\
...
\begin{align}
    \delta \leq \frac{2\gamma}{\|k\|^{\tau + 1}_1} \notag
\end{align}
...
\begin{align}
    m(R_{\gamma, \tau} \cap \Omega) \leq \sum_{k \neq 0}m(R_{\gamma, \tau, k} \cap \Omega) = o(\gamma) \tag{5.27}
\end{align}
