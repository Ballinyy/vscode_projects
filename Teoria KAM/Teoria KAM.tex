...
\textbf{Esempio:} il differenziale di una funzione è una $1$-forma differenziabile. Consideriamo ad esempio la funzione reale $f$ definita da $x \mapsto x^2$. Il suo differenziale $df$ è
\begin{align}
    df = 2x \, dx \tag{1.6.1}
\end{align}
