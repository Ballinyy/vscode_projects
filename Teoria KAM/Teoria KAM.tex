...
\end{align} \\
\textbf{Proposizione 1.3.2:} il prodotto esterno di monomi è associativo e anticommutativo. \\
...
Osserviamo che l'anticommutatività comporta la commutatività se $kl$ è pari.
...
\textbf{Dimostrazione:} siano $\omega^{(k)}$, $\omega^{(l)}$ e $\omega^{(m)}$ rispettivamente una $k$-forma, una $l$-forma e una $m$-forma su $\mathbb{R}^n$. \\
