...
\textbf{2.} Il flusso $\varphi_t$ del campo vettoriale costante $\alpha$ è \textit{ergotico}, ovvero tutte le funzioni $f$ di $\mathbb{T}^n$ che soddisfano
\begin{align}
...
\begin{align}
    \widehat{f \circ \varphi_t}(k) = e^{i2\pi k \cdot \alpha}\int_{\mathbb{T}^n} e^{-i2\pi k \cdot \theta'}f(\theta') \, d\theta' = e^{i2\pi k \cdot \alpha}\widehat{f}(k) \tag{3.21}
\end{align}
