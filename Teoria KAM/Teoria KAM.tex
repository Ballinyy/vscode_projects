...
\newpage
\subsection{Forme differenziali su varietà}
...
\textbf{Dimostrazione:} sia $\omega$ una $1$-forma su $\mathbb{R}$. Allora $\omega$ si può scrivere come 
\begin{align}
    \omega = adx \tag{1.6.9}
\end{align}
...
\end{align}
 ...
 \begin{align}
    \omega = a_1(x)dx_1 + \dots + a_n(x)dx_n \tag{1.6.20}
 \end{align}
 ...
 \begin{align}
    \omega^{(k)} : TM \longrightarrow \mathbb{R} \tag{1.7.1}
 \end{align}
...
\end{align}
mentre $\overline{f} = 0$. \\ \\
$(1 \rightarrow 4)$ Supponiamo che $\varphi_t$ ammetta una traiettoria \textit{non} densa. Allora esiste $\theta_0 \in \mathbb{T}^n$ che possiede un intorno aperto $U$ che non interseca con la traiettoria. Segue che la traiettoria è periodica (indichiamo con $\tau$ il periodo), questo perché le soluzioni del moto sono definite per ogni $t \in \mathbb{R}$ e $\mathbb{T}^n$ è compatto.
