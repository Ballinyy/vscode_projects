...
In particolare, $\mathbb{T}^n_s$ è compatto e ogni funzioni olomorfa è continua, pertanto se $f \in \mathcal{O}(\mathbb{T}^n_s)$ segue che $\|f\|_\infty < \infty$. Concludiamo che la coppia $(\mathcal{O}(\mathbb{T}^n_s), \|\cdot\|_\infty)$ è uno spazio di Banach\footnote{Teorema A.$1$ in appendice A.}. \\ \\
Invertendo $(5.10)$, $F$ è univocamente determinato dall'azione di $\mathcal{L}^{-1}_\alpha$ su $\tilde{H}_1$. Tuttavia, affinché $\mathcal{L}^{-1}_\alpha$ mappi funzioni olomorfe a funzioni olomorfe, necessitiamo delle condizioni aritmetiche sul vettore frequenza $\alpha$, che garantiscono sufficiente 'lontananza' dalla risonanza. \\ \\
\textbf{Definizione 5.1:} per $\gamma, \tau > 0$, $\alpha \in \mathbb{R}^n$ è detto $(\gamma, \tau)$-\textit{Diofanteo} se 
\begin{align}
    |k \cdot \alpha| \leq |k|^{-\tau}\gamma \tag{5.16}
\end{align}
per ogni $k \in \mathbb{Z}^n \setminus \{0\}$, dove
\begin{align}
    |k| = |k_1| + \dots + |k_n| \tag{5.17}
\end{align}
In particolare, indichiamo con $D_{\gamma, \tau}$ l'insieme di tutti i vettori $\alpha \in \mathbb{R}^n$ che sono $(\gamma, \tau)$-Diofantei, mentra
\begin{align}
