...
\begin{align}
    \mathbf{A} = \frac{2\hbar(N(\omega) + 1)}{\varepsilon_0\omega V}\frac{1}{r}e^{-i(\mathbf{k} \cdot \mathbf{r} - \omega t - \delta_\omega)}\mathbf{u} \tag{1.4.13}
\end{align}
...
\begin{align}
    M_{fi} &= \braket{f|e^{i\mathbf{k} \cdot \mathbf{r}}\mathbf{u} \cdot \nabla|i} \notag \\
    &\sim \frac{i}{\hbar}\braket{f|\mathbf{u} \cdot \mathbf{p}|i} \tag{1.4.15}
\end{align}
Inoltre $\mathbf{p} = \frac{m}{i\hbar}[\mathbf{r}, H_0]$, infatti 
\begin{align}
    [\mathbf{r}, H_0] &= [\mathbf{r}, \frac{\mathbf{p}^2}{2m} + \cancel{V(r)}] \notag \\
    &= \frac{1}{2m}[\mathbf{r}, \mathbf{p}^2] = \frac{i\hbar}{m}\mathbf{p} \tag{1.4.16}
\end{align}
...
\begin{align}
    ...
    &= \frac{m\omega_{fi}}{\hbar}\mathbf{r}_{fi} \cdot \mathbf{u} \tag{1.4.17}
\end{align}
...
Allora 
\begin{align}
    \braket{f|\mathbf{r}_{fi} \cdot \mathbf{u}|i} = \sum_{q = -1}^1 u_q\braket{f|r_q|i} \tag{1.4.19}
\end{align}
In particolare 
\begin{align}
    \braket{f|r_q|i} &= \sqrt{\frac{4\pi}{3}}\int_0^\infty dr \, R_{nlm}R_{n'l'm'}r^3 \int_0^{2\pi}d\varphi \int_0^\pi \sin\theta d\theta \, Y_{nlm}Y_{1q}Y_{n'l'm'} \tag{1.4.20}
\end{align}
...
\begin{align}
    H = \frac{(\mathbf{p} + \mathbf{A})^2}{2m} - \frac{Z}{r} \tag{1.5.1}
\end{align}
...
\begin{align}
    ...
    &\sim \frac{\mathbf{p}^2}{2m} + \frac{\mathbf{p} \cdot \mathbf{A}}{m} - \frac{Z}{r} = H_0 + \frac{\mathbf{p} \cdot \mathbf{A}}{m} \tag{1.5.2}
\end{align}
...
\begin{align}
    ...
    &= \frac{1}{2}\mathbf{L} \cdot \mathbf{B} \tag{1.5.3}
\end{align}
...
\begin{align}
    ...
    &= \frac{1}{8}\mathbf{B}^2\left(1 - \frac{1}{3}\right)\braket{\mathbf{r}^2}_{n00} \tag{1.5.4} 
\end{align}
...
\begin{align}
    -\mathbf{m} \cdot \mathbf{B} = \mathbf{p} \cdot \mathbf{A} \tag{1.5.5}
\end{align}
...
\begin{align}
    -\mathbf{m} = -\frac{e\omega}{2\pi}\pi R^2 \hat{n} = \frac{e\omega R^2}{2}\hat{n} = \frac{e\mathbf{L}}{2m} = -\frac{\mu_B}{\hbar}\mathbf{L} \tag{1.5.6}
\end{align}
...
\begin{align}
    -\mathbf{m} = -\frac{\mu_B}{\hbar}(\mathbf{L} + g\mathbf{S}) \tag{1.5.7}
\end{align}
...
\begin{align}
    H = H_0 + \frac{\mu_B}{\hbar}(L_z + 2S_z)B \tag{1.5.8}
\end{align}
...
\begin{align}
    ...
    &= E_n + \frac{\mu_BB}{\hbar}(m_l + 2m_s) \tag{1.5.9}
\end{align}
...
\begin{align}
    H = H_0 + \frac{\mu_B}{\hbar}(L_z + 2S_z)B + f(r)\mathbf{L} \cdot \mathbf{S} \tag{1.5.10}
\end{align}
In particolare possiamo scrivere
\begin{align}
    \mathbf{L} \cdot \mathbf{S} = \frac{1}{2}(\mathbf{J}^2 - \mathbf{L}^2 - \mathbf{S}^2) \tag{1.5.11}
\end{align}
e sostituendo $(1.5.11)$ in $(1.5.10)$ si ottiene 
\begin{align}
    H = H_0 + \frac{\mu_B}{\hbar}(L_z + 2S_z)B + \frac{1}{2}f(r)(\mathbf{J}^2 - \mathbf{L}^2 - \mathbf{S}^2) \tag{1.5.12}
\end{align}
...
\begin{align}
    \Delta E^{(1)} &= \braket{f(r)}\braket{\mathbf{L} \cdot \mathbf{S}} \notag \\
    &= \int_0^\infty dr \, R_{nl}(r)f(r)R_{nl}(r) \cdot \braket{\mathbf{L} \cdot \mathbf{S}} \notag \\
    &= \int_0^\infty dr \, |R_{nl}(r)|^2\frac{\alpha^2}{2}\frac{1}{r}\frac{dV}{dr} \cdot \braket{\mathbf{L} \cdot \mathbf{S}} \notag \\
    &=
\end{align}
