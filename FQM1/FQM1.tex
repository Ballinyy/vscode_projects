...
\begin{align}
    ...
    &\sim H_0 + \frac{\mathbf{p} \cdot \mathbf{A}}{m} = H_0 + \frac{i\hbar}{m}\nabla \cdot \mathbf{A} \tag{1.3.2}
\end{align} 
dove si è trascurato il termine quadratico $\mathbf{A}^2$ per campi elettromagnetici poco intensi. Notiamo che $\nabla \cdot \mathbf{A}$ è da intendere come operatore che agisce sullo spazio di Hilbert in esame.
