...
\end{align}
studiamo come si comporta il modulo 
\begin{align}
    \left(\frac{e^{i\tilde{\omega}_{fi}t} - 1}{i\tilde{\omega}_{fi}}\right)\left(-\frac{e^{-i\tilde{\omega}_{fi}t} - 1}{i\tilde{\omega}_{fi}}\right) &= \frac{2(1 - \cos(\tilde{\omega}_{fi}t))}{\tilde{\omega}^2_{fi}} \notag \\
    &= \frac{\sin^2(\tilde{\omega}_{fi}t)}{\tilde{\omega}^2_{fi}} = F(t, \tilde{\omega}_{fi}) \tag{1.4.9}
\end{align}
