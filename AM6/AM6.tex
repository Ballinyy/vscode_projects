...
\textbf{Dimostrazione:} $(1)$ dimostriamo che $\rho(T)$ è aperto facendo vedere che per ogni elemento in $\rho(T)$ esiste un suo intorno contenuto in $\rho(T)$. Sia $\lambda \in \rho(T)$, allora $(\lambda\mathbf{1} - T)$ è invertibile. 
