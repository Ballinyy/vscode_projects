...
\end{align}
ovvero l'insieme delle classi di equivalenza tra successioni di Cauchy in $X$ rispetto a $\sim$. Su $\overline{X}$ introduciamo struttura di spazio metrico defininendo come operazione di somma $+$ la seguente 
\begin{align}
...
\begin{align}
    \lim_{n \rightarrow \infty}\overline{d}(y_n, y'_n) = \lim_{n \rightarrow \infty}\overline{d}(z_n, z'_n) \notag 
\end{align}
ovvero 
\begin{align}
    \lim_{n \rightarrow \infty}(\overline{d}(y_n, y'_n) - \overline{d}(z_n, z'_n)) = 0 \notag
\end{align}
per la disuguaglianza triangolare si ha 
\begin{align}
    \lim_{n \rightarrow \infty}\overline{d}(y_n, y'_n) &\leq \lim_{n \rightarrow \infty} (\cancel{\overline{d}(y_n, z_n)} + \overline{d}(z_n, y'_n)) \notag \\
    &\leq \lim_{n \rightarrow \infty}(\overline{d}(z_n, z'_n) + \cancel{\overline{d}(z'_n, y'_n)}) \notag \\
    &= \lim_{n \rightarrow \infty}\overline{d}(z_n, z'_n) \notag
\end{align}
analogamente vale la disuguaglianza inversa, infatti
\begin{align}
    \lim_{n \rightarrow \infty}\overline{d}(z_n, z'_n) &\leq \lim_{n \rightarrow \infty}(\cancel{\overline{d}(z_n, y_n)} + \overline{d}(y_n, z'_n)) \notag \\
    &\leq \lim_{n \rightarrow \infty}(\overline{d}(y_n, y'_n) + \cancel{\overline{d}(y'_n, z'_n)}) \notag \\
    &= \lim_{n \rightarrow \infty}\overline{d}(y_n, y'_n) \notag
\end{align}
...
\begin{align}
    \{[\{x^m_n\}_{n \in \mathbf{N}}]\}_{m \in \mathbf{N}} \subset \overline{X} \notag
\end{align}
