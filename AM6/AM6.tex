...
\textbf{Dimostrazione:} $(\rightarrow)$ se $V^*$ è l'inverso bilatero di $V$ si ha che $V$ è isometrico e suriettivo, quindi unitario, per quanto sopra osservato.  \\ \\
$(\leftarrow)$ Analogente, segue immediatamente dall osservazioni sopra citate. \qed \\ \\
...
\textbf{2.} $T^*$ è invertibile in $\mathcal{B}(\mathcal{H})$. \\
...
\textbf{Dimostrazione:} $(1 \rightarrow 2)$
