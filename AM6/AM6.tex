...
\begin{align}
    ...
    &< 2\varepsilon \notag
\end{align}
per continuità della norma, per ogni $n > N_\varepsilon$. Notiamo che esiste $N_1 \in \mathbf{N}$ tale che fissato $n > N_1$ si ha
\begin{align}
...
\begin{align}
    ...
    &< 2\varepsilon \notag
\end{align}
per continuità della norma, per ogni $n > N_\varepsilon$. \\ \\
