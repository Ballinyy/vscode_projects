...
\textbf{Dimostrazione:} poiché per ipotesi $D_1 \supset D_2 \supset \dots$ si ha che $d(x_n, x_m) < |r_n - r_m|$ per ogni $n, m \in \mathbf{N}$. Allora $\{x_n\}_{n \in \mathbf{N}}$ è di Cauchy e quindi convergente 
